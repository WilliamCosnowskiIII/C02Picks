...
export function LeagueCard({ league }: LeagueCardProps) {
  return (
    <Link
      href={`/league/${league.platform}/${league.id}?season=${league.season}`}
      className="block rounded-2xl border border-zinc-200 bg-white p-5 shadow-sm transition hover:border-emerald-400 hover:shadow-md dark:border-zinc-800 dark:bg-zinc-950 dark:hover:border-emerald-600"
    >
      <article>
